...
@WebServlet(urlPatterns = "/carregar-livro")
public class CarregarLivroBean extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rq = req.getRequestDispatcher("form-alterar-livro.jsp");
		rq.forward(req, resp);
